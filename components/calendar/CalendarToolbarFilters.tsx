...
const UNIT_TYPE_META = [
  ...
  { value: 'rest_house', icon: Home, color: 'text-slate-900 dark:text-white', bg: 'from-slate-500/15 to-slate-600/10', ring: 'ring-slate-400/40' },
] as const
...
export function CalendarToolbarFilters() {
  ...
  }, [locations, isStaffOnly, currentStaff?.location_id, isRocketScoped])
