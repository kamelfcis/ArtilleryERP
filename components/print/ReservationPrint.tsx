...
export function ReservationPrint({ reservation }: ReservationPrintProps) {
  ...
  async function handlePrint() {
    ...
    const servicesTotal = reservationServices?.reduce((sum, rs) => sum + rs.total_amount, 0) || 0

    // Use merge price if enabled, otherwise use reservation total
    const effectiveTotal = isMerge && mergePrice ? parseFloat(mergePrice) : reservation.total_amount
      ...
      <html dir="rtl" lang="ar">
        ...
        <div class="page rules-page">
          ...
          <ol>
            ...
            <li>تسليم الوحدة السكنية سعت ١٢٠٠ والمغادرة سعت ١٠٠٠ نهاية يوم التعاقد.</li>
            <li>يتم دفع قيمة تأمين للشاليه ٥٠٠ ج.م والشقة والفيلا ١٠٠٠ ج.م عند الإسكان فى القرية.</li>
            <li>يجب تسليم الشقة نظيفة؛ وفى حالة عدم تسليم الوحدة نظيفة يتم خصم ٢٠٠ ج.م من قيمة التأمين المدفوع فى القرية.</li>
            ...
            <li>غير مسموح بأستعمال الشوايات داخل الوحدات السكنية.</li>
            ...
            <li>فى حالة ارتجاع العقد يتم خصم مبلغ ٢٥٪ من إجمالى قيمة التعاقد حتى ٣ أيام بخلاف يوم بداية العقد.</li>
            <li>فى حالة ارتجاع العقد قبل يوم بداية التعاقد بأقل من ٣ أيام يتم خصم ٥٠٪ من قيمة التعاقد.</li>
            <li>لايسمح بارتجاع قيمة العقد بعد مضى أول يوم تعاقد.</li>
            ...
            <li>لايسمح بتعديل الحجز سواء بالتقديم أو التأخير لمدة الحجز ويعتبر أى تعديل على المده بمثابة تعاقد جديد تطبق عليه إشتراطات الحجز فى البنود ( ١٤ - ١٥ - ١٦ ).</li>
            <li>حدد الأرقام الآتية للرد على التساؤلات والشكاوى ( ٠١٠٢٢٧٣٨٩١٢ - ٠١٢١١٥٣٤٨٥٩ - ٢٢٩١٠٦٠٩ ).</li>
