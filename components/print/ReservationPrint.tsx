      ...
      <html dir="rtl" lang="ar">
        ...
        <div class="page rules-page">
          ...
          <ol>
            ...
            <li>لايسمح بتعديل الحجز سواء بالتقديم أو التأخير لمدة الحجز ويعتبر أى تعديل على المده بمثابة تعاقد جديد تطبق عليه إشتراطات الحجز فى البنود ( 1 - 2  بالملاحظات ).</li>
