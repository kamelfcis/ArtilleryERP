...
# Use ONLY after https://api-artillery.pdfnox.com/health returns Artillery JSON and
# Edge Config backendUrl is https://api-artillery.pdfnox.com.
#
...
$CanonicalBackendUrl = "https://api-artillery.pdfnox.com"
